...
from core.campus.models import Provincia

class ProvinciaListView(LoginRequiredMixin, ValidatePermissionRequiredMixin, ListView):
    model = Provincia
    template_name = 'provincia/list.html'
    permission_required = (
        'users.view_provincia',
        'users.add_provincia', 
        'users.change_provincia', 
        'users.delete_provincia',
    )
    ...
    def get_context_data(self, **kwargs):
        ...
        context[views.TITLE] = 'Provincias'
        #context[views.CREATE_URL] = reverse_lazy('users:area_create')
        context[views.LIST_URL] = reverse_lazy('campus:provincia_list')
        context[views.ENTITY] = 'Provincias'
