...
from core.campus.models import Barrio

class BarrioListView(LoginRequiredMixin, ValidatePermissionRequiredMixin, ListView):
    model = Barrio
    template_name = 'barrio/list.html'
    permission_required = (
        'users.view_barrio',
        'users.add_barrio', 
        'users.change_barrio', 
    ...
    def get_context_data(self, **kwargs):
        ...
        context[views.TITLE] = 'Barrios'
        #context[views.CREATE_URL] = reverse_lazy('users:area_create')
        context[views.LIST_URL] = reverse_lazy('campus:barrio_list')
        context[views.ENTITY] = 'Barrios'
