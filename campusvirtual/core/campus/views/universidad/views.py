...
from core.campus.models import Universidad

class UniversidadListView(LoginRequiredMixin, ValidatePermissionRequiredMixin, ListView):
    model = Universidad
    template_name = 'universidad/list.html'
    permission_required = (
        'users.view_universidad',
        'users.add_universidad', 
        'users.change_universidad', 
        'users.delete_universidad',
    )
    ...
    def get_context_data(self, **kwargs):
        ...
        context[views.TITLE] = 'Universidades'
        #context[views.CREATE_URL] = reverse_lazy('users:area_create')
        context[views.LIST_URL] = reverse_lazy('campus:universidad_list')
        context[views.ENTITY] = 'Universidades'
