...
from core.campus.models import Campus

class CampusListView(LoginRequiredMixin, ValidatePermissionRequiredMixin, ListView):
    model = Campus
    template_name = 'facultad/list.html'
    permission_required = (
        'users.view_facultad',
        'users.add_facultad', 
        'users.change_facultad', 
        'users.delete_facultad',
    )
    ...
    def get_context_data(self, **kwargs):
        ...
        context[views.TITLE] = 'Campus'
        #context[views.CREATE_URL] = reverse_lazy('users:area_create')
        context[views.LIST_URL] = reverse_lazy('campus:facultad_list')
        context[views.ENTITY] = 'Campus'
